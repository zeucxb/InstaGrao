...
// MatchsScreen is a StatefulWidget. This allows us to update the state of the
// Widget whenever an item is removed.
class MatchsScreen extends StatefulWidget {
  MatchsScreen({Key key}) : super(key: key);

  @override
  _MatchsScreen createState() => _MatchsScreen();
}

class _MatchsScreen extends State<MatchsScreen> {
